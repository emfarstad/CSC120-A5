...
___IDK__ 1 pt: The `Train` class has all expected attributes / relationships with the other classes
...
___IDK__ 4 pts: Programs compile without errors or warnings
